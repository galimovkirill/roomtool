...
Если запрос пользователя неоднозначный, неполный или допускает несколько равнозначных трактовок — **сначала задай уточняющие вопросы**, прежде чем приступать к реализации. Не угадывай намерения там, где один уточняющий вопрос сэкономит переделку.

Не спрашивай об очевидном: если задача конкретна и контекст понятен — действуй.
